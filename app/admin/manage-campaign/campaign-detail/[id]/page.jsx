...
export default function CampaignDetail() {
  ...
  const fetchdata = async () => {
    try {
      const respond = await axios.get(`/api/campaign-transactions?id=${id}`)
      setCampaigns(respond.data);
    } catch (error) {
  ...
  const fetachName = async (id) => {
    const respond = await axios.get(`/api/campaign-transactions/name?id=${id}`);
    setnamecampaign(respond.data);
  };
